...
<details>
<summary><b>[134] Tilt-Neon[HROT,VROT].ttf</b></summary>
<details>
...
objc[42349]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** The file 'Tilt-Neon[HROT,VROT].ttf' must be renamed to 'TiltBetaNeon[HROT,VROT].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* 🔥 **FAIL** License file OFL.txt exists but NameID 13 (LICENSE DESCRIPTION) value on platform 3 (WINDOWS) is not specified for that. Value was: "EARLY BETA VERSION, please don't redistribute! Thanks --Andy" Must be changed to "This Font Software is licensed under the SIL Open Font License, Version 1.1. This license is available with a FAQ at: http://scripts.sil.org/OFL" [code: wrong]
...
* 🔥 **FAIL** The NameID.VERSION_STRING (nameID=5) value must follow the pattern "Version X.Y" with X.Y greater than or equal to 1.000. Current version string is: "0.5 BETA 2019_12_16" [code: bad-version-strings]
...
"EARLY BETA VERSION, please don't redistribute! Thanks --Andy" [code: bad-notice-format]
...
* 🔥 **FAIL** head version is "0.005" while name version string (for platform 3, encoding 1) is "0.5 BETA 2019_12_16". [code: mismatch]
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries:
 FONT_FAMILY_NAME = 'Tilt Beta Neon Regular' / SUBFAMILY_NAME = 'Regular'
...
<details>
<summary>💤 <b>SKIP:</b> Whitespace and non-breaking space have the same width?</summary>
...
|  | fonts/Tilt-Neon[HROT,VROT].ttf |
|:--- | ---:|
| Dehinted Size | 272.8kb |
| Hinted Size | 272.1kb |
| Increase | -672 bytes |
| Change   | -0.2 % |
 [code: size-impact]
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['0.5 BETA 2019_12_16'] [code: version-not-detected]
...
* ℹ **INFO** Version string is: "0.5 BETA 2019_12_16"
...
* ℹ **INFO** This font contains the following optional tables [GPOS, loca]
...
* 🍞 **PASS** Instances have correct coordinates
...
* 🍞 **PASS** Instances have correct names
